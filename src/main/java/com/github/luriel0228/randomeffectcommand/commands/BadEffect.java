...
public class BadEffect implements CommandExecutor {

    private final RandomEffect plugin;

    public BadEffect(RandomEffect plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        PotionEffectType randomEffect = badEffects.get(random.nextInt(badEffects.size()));
        ...
        player.sendMessage(ChatColor.RED + "해로운 역할: 랜덤한 효과를 얻었습니다 - " + randomEffect.getName());
